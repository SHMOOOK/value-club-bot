...
async def start(
    ...
    await update.message.reply_text(
        "مرحباً بكِ ياذات الهِمَّة في نادي التحديات القيمية، حيث تنضمِّين إلى رحلة ممتعة للغرس القيمي 🌱\n\nفضلا قومي بالاختيار من القائمة التالية:",
...
async def button_handler(
    ...
    if query.data == "plans":
        ...
        await query.message.reply_text(
            "اختاري خطة الاشتراك المناسبة لك:",
            reply_markup=InlineKeyboardMarkup(keyboard)
        )
        ...
        await query.message.reply_text(
            "للتواصل مع إدارة النادي يُرجى المراسلة على البريد التالي ch.club48@gmail.com ، أو التواصل على رقم الواتس أب الخاص بالنادي +966538438399 ، لنادي التحديات القيمية، هو أوّل نادٍ قيمي تربوي متخصص، بإشراف أخصائية القيم المعتمدة أ.أمل المنقور، هدفُه تحويل القيم من مفاهيم نظرية مجرّدة إلى ممارسات يومية باستخدام فنّ التلعيب القيمي وتصميم التحديات القيمية الإبداعية، داخل الأسرة أو في المدرسة، أو في المراكز والدُّور، ويستهدف غالبية الفئات العمرية من عمر 7 سنوات وحتى 30 عاما ✨📚 🌱"
        )
